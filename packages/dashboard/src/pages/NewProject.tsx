...
const styles = {
  container: { maxWidth: "700px", padding: "3rem 2rem", margin: "0 auto" },
  title: { fontSize: "1.8rem", fontWeight: 700, marginBottom: "2rem" },
  form: { display: "flex", flexDirection: "column" as const, gap: "1rem" },
  label: { fontSize: "0.95rem", color: "#aaa", marginBottom: "0.35rem" },
  input: {
    width: "100%",
