...
const s = {
  page: { maxWidth: "1000px", margin: "0 auto", padding: "0.5rem 1.5rem" },
  ...
  grid: { display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" as const },
  card: (current: boolean) => ({ background: "#12121a", border: `1px solid ${current ? "#7c3aed" : "#1e1e30"}`, borderRadius: "0.75rem", padding: "1.25rem", position: "relative" as const, flex: "1 1 200px", maxWidth: "240px", minWidth: "180px" }),
