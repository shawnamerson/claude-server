...
const s = {
  ...
  card: (current: boolean) => ({ background: "#12121a", border: `1px solid ${current ? "#7c3aed" : "#1e1e30"}`, borderRadius: "0.75rem", padding: "1.25rem", position: "relative" as const, display: "flex", flexDirection: "column" as const }),
  ...
  featureList: { listStyle: "none", padding: 0, margin: "0 0 1.25rem 0", flex: 1 },
